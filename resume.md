...
Python (Flask, SQLAlchemy, Alembic) · PostgreSQL · Terraform · GitHub Actions · Docker · Nix · AWS (EC2, S3, CloudFront) · Auth0 · Aptible · Grafana · New Relic · Heap · Python · Kubernetes & Kustomize · Jenkins Pipelines · Prefect · Node.js (Express & Vue) · Flask · Alembic · MS SQL Server · GraphQL · Python packaging · Pytest · LaTeX · Sphinx · Linux · Vim · Perforce · JIRA · Jenkins · Agile · Test-driven development · Elastic stack · SolidWorks (FEA) · C++ · Java · Machine shop · Feedback controls · Git · Arduino · MATLAB · LabVIEW · Proxmox · Kubernetes · ZFS · Ansible · Samba · Mumble · Plex · Borg backup · Beets · NGINX
